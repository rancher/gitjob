...
func TestAzureDevopsWebhookWithSshUrl(t *testing.T) {
	const (
		...
		repoURL       = "git@ssh.dev.azure.com:v3/fleet/git-test/git-test"
		remoteRepoURL = "https://dev.azure.com/fleet/git-test/_git/git-test"
	)
	gitjob := &v1.GitJob{
